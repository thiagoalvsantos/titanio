...
<body>
	<section class="grid_4 block-content ">
		<h1>Acesso Rápido</h1>
		
		<div class="block-controls">
			<ul class="controls-buttons">
				<li><a href="#" title="Adicionar"><img
		...
		<ul class="favorites no-margin with-tip"
			...
			<li><g:img file="icons/web-app/48/Projetos.png" width="48"
				height="48"/> <g:link controller="projeto">Projetos<br> <small>Projetos</small></g:link>
				<ul class="mini-menu">
			...
			<li><img src="images/icons/web-app/48/Pie-Chart.png" width="48"
				height="48"> <g:link controller="resumo">Resumo<br> <small>Status
						&gt; Resumo</small></g:link>
				<ul class="mini-menu">
					<li><a href="#" title="Move up"><img
							src="images/icons/fugue/arrow-090.png" width="16" height="16"></a></li>
